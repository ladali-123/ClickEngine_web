      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="mt-3 mx-auto max-w-xl text-base leading-relaxed text-slate-500">
            Complete digital solutions — from building your web presence to ranking it, advertising it, and growing it.
          </p>
        </div>

        {/* 4 Cards — exactly like reference */}
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          {SERVICES.map((s, i) => (
            <div
              key={i}
              className="group relative flex flex-row items-stretch bg-white border border-slate-200 rounded-2xl overflow-hidden cursor-pointer hover:shadow-lg hover:border-slate-300 transition-all duration-300"
            ...
            >
              ...
              <div className="flex flex-col justify-between p-7 z-10 w-[55%]">
                ...
                <button className="flex items-center gap-1.5 text-sm font-semibold text-slate-600 group-hover:text-blue-500 transition-colors duration-200 w-fit border-none bg-transparent p-0 cursor-pointer">
                  Read More
              ...
              {/* Right: Image flush to edge — exactly like reference */}
              <div className="absolute right-0 top-0 bottom-0 w-[50%]">
                ...
                />
                {/* Smooth left fade so text stays readable */}
